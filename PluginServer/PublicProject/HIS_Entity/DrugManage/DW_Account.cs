...
{
    [Serializable]
    [Table(TableName = "DW_Account", EntityType = EntityType.Table, IsGB = false)]
    public class DW_Account:AbstractEntity
    {
        ...
        private Decimal  _lendamount;
        /// <summary>
        /// 借方数量
        /// </summary>
        [Column(FieldName = "LendAmount", DataKey = false, Match = "", IsInsert = true)]
        public Decimal LendAmount
        {
            get { return  _lendamount; }
            set {  _lendamount = value; }
        }
