...
{
    [Serializable]
    [Table(TableName = "DW_AuditDetail", EntityType = EntityType.Table, IsGB = false)]
    public class DW_AuditDetail:AbstractEntity
    {
        ...
        private int  _drugstoreid;
        /// <summary>
        /// 
        /// </summary>
        [Column(FieldName = "DrugStoreID", DataKey = false, Match = "", IsInsert = true)]
        public int DrugStoreID
        {
            get { return  _drugstoreid; }
