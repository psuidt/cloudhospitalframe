...
{
    [Serializable]
    [Table(TableName = "DW_InStoreHead", EntityType = EntityType.Table, IsGB = false)]
    public class DW_InStoreHead:AbstractEntity
    {
