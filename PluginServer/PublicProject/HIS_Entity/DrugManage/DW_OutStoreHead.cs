...
{
    [Serializable]
    [Table(TableName = "DW_OutStoreHead", EntityType = EntityType.Table, IsGB = false)]
    public class DW_OutStoreHead : AbstractEntity
    {
        ...
        private int _instoreheadid;
        /// <summary>
        /// 
        /// </summary>
        [Column(FieldName = "InStoreHeadID", DataKey = false, Match = "", IsInsert = true)]
        public int InStoreHeadID
        {
            get { return _instoreheadid; }
            set { _instoreheadid = value; }
        }
        ...
        public int ApplyHeadId { set; get; }
