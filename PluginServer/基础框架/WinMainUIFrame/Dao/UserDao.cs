...
namespace WinMainUIFrame.Dao
{
    public class UserDao : AbstractDao
    {
        ...
        public BaseUser GetUser(string code)
        {
            ...
            if (dt.Rows.Count > 0)
                return oleDb.Query<BaseUser>(strsql, String.Empty).FirstOrDefault();
            else
                return null;
        }
        ...
        public List<BaseDept> GetHaveDept(int empId)
        {
            ...
            DataTable dt = oleDb.GetDataTable(strsql);
            if (dt.Rows.Count > 0)
                return oleDb.Query<BaseDept>(strsql, String.Empty).ToList();
            else
        ...
        public List<BaseModule> GetModuleList(int userId)
        {
            ...
            DataTable dt = oleDb.GetDataTable(strsql);
            if (dt.Rows.Count > 0)
                return oleDb.Query<BaseModule>(strsql, String.Empty).ToList();
            else
        ...
        public List<BaseMenu> GetMenuList(int userId)
        {
            ...
            DataTable dt = oleDb.GetDataTable(strsql);
            if (dt.Rows.Count > 0)
                return oleDb.Query<BaseMenu>(strsql, String.Empty).ToList();
            else
        ...
        public BaseDept GetDefaultDept(int empId)
        {
            ...
            DataTable dt = oleDb.GetDataTable(strsql);
            if (dt.Rows.Count > 0)
                return oleDb.Query<BaseDept>(strsql, String.Empty).FirstOrDefault();
            else
                return null;
        }
