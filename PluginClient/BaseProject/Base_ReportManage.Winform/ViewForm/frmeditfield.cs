...
namespace base_reportmanage.winform.ViewForm
{
    public partial class frmEditField : DialogForm, IfrmEditField
    {
        ...
        private BaseReportField _currField;
        public BaseReportField currField
        {
            get
            {
                frmForm1.GetValue<BaseReportField>(_currField);
                return _currField;
            }
            set
            {
                _currField = value;
                frmForm1.Load<BaseReportField>(_currField);
