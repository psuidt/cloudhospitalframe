...
using System.Linq;
using System.Text;
using EfwControls.HISControl.PrescriptionTmp.Controls.CommonMvc;
using EfwControls.HISControl.PrescriptionTmp.Controls.Entity;
using EfwControls.Common;

namespace EfwControls.HISControl.PrescriptionTmp.Controls.Action
{
    internal class PrescriptionControlController : BaseController<IPrescriptionControl>
    {
        ...
        private Entity.Prescription ItemWritePresRowValue(DataTable presdt, int rowIndex, DataRow row)
        {
            ...
            int newIndex = 0;
            bool bChangePres = AutoChangePres(mPres.PresNo, mPres, presdt, rowIndex, out newIndex);
