    ...
    public partial class StatDateTime : UserControl
    {
        ...
        public int DateWidth
        {
            ...
            set
            {
                ...
                _dateWidth = value;
                this.Width = this.bdate.Width + this.edate.Width + this.labelX1.Width;
            }
        }
        ...
        public StatDateTime()
        {
            ...
            this.Font = new Font("宋体", (float)9.5);
            //DateWidth = 120;
            this.Width = 290;
            this.Height = bdate.Height;
        }
        ...
        private dateData CalculationDate(DateTime now, string name)
        {
            ...
            {
                case "本周":
                    begin = now.AddDays(0 - (int)now.DayOfWeek+1);
                    end = now.AddDays(6 - (int)now.DayOfWeek+1);
                    break;
                case "本月":
            ...
            return new dateData(name,Convert.ToDateTime( begin.ToString("yyyy-MM-dd 00:00:00")),Convert.ToDateTime( end.ToString("yyyy-MM-dd 23:59:59")));
        }
        ...
        {
            int _width = this.Width < 350 ? 350 : this.Width;
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            if (_showStyle == showStyle.horizontal)
            {
                this.Height = this.bdate.Height;
            }
            else
            {
                this.Height = this.bdate.Height + this.edate.Height;
            }
            int _DateWidth = (this.Width - this.labelX1.Width - 15) / 2;
            this.bdate.Width = _DateWidth;
            this.edate.Width = _DateWidth + 15;
